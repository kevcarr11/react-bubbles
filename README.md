...
- [ ] Explain what a token is used for.
  A token is a long encrypted string generated by the server and given  at login to use to give access to protected data and resources instead of login credentials.

- [ ] What steps can you take in your web apps to keep your data secure?
  Once we have this token, we can add two layers of protection to our app. One with protected routes, 
  the other by sending an authentication header with our API calls.
